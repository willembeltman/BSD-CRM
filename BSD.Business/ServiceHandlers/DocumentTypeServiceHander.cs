...
public class DocumentTypeServiceHander
{
    private readonly AuthenticationState State;

    public DocumentTypeServiceHander(AuthenticationState authenticationState)
    {
    ...
    public DocumentType? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.DocumentType dto) => db.DocumentTypes.FirstOrDefault(a => a.Id == dto.Id);
