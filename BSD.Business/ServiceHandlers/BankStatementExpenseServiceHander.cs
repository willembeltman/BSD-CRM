...
public class BankStatementExpenseServiceHander
{
    private readonly AuthenticationState State;

    public BankStatementExpenseServiceHander(AuthenticationState authenticationState)
    {
    ...
    public BankStatementExpense? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.BankStatementExpense dto) => db.BankStatementExpenses.FirstOrDefault(a => a.Id == dto.Id);
