...
public class CustomerServiceHander
{
    private readonly AuthenticationState State;

    public CustomerServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Customer? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Customer dto) => db.Customers.FirstOrDefault(a => a.Id == dto.Id);
