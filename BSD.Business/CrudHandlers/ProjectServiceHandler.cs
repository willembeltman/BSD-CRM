...
public class ProjectServiceHandler
{
    ...
    public ProjectServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public Project? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Project dto) => null;
