...
public class ExpenseProductServiceHander
{
    private readonly AuthenticationState State;

    public ExpenseProductServiceHander(AuthenticationState authenticationState)
    {
    ...
    public ExpenseProduct? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.ExpenseProduct dto) => db.ExpenseProducts.FirstOrDefault(a => a.Id == dto.Id);
