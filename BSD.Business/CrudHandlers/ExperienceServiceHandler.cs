...
public class ExperienceServiceHandler
{
    private readonly AuthenticationState State;

    public ExperienceServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public Experience? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Experience dto) => null;
