...
public class TechnologyServiceHandler
{
    private readonly AuthenticationState State;

    public TechnologyServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public Technology? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Technology dto) => null;
