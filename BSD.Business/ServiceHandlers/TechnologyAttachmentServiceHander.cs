...
public class TechnologyAttachmentServiceHander
{
    private readonly AuthenticationState State;

    public TechnologyAttachmentServiceHander(AuthenticationState authenticationState)
    {
    ...
    public TechnologyAttachment? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.TechnologyAttachment dto) => db.TechnologyAttachments.FirstOrDefault(a => a.Id == dto.Id);
