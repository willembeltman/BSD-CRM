...
public class TransactionServiceHander
{
    private readonly AuthenticationState State;

    public TransactionServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Transaction? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Transaction dto) => db.Transactions.FirstOrDefault(a => a.Id == dto.Id);
