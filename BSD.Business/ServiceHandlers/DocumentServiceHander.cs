...
public class DocumentServiceHander
{
    private readonly AuthenticationState State;

    public DocumentServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Document? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Document dto) => db.Documents.FirstOrDefault(a => a.Id == dto.Id);
