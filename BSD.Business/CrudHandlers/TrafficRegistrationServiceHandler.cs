...
public class TrafficRegistrationServiceHandler
{
    private readonly AuthenticationState State;

    public TrafficRegistrationServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public TrafficRegistration? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.TrafficRegistration dto) => null;
