...
public class RateServiceHander
{
    private readonly AuthenticationState State;

    public RateServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Rate? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Rate dto) => db.Rates.FirstOrDefault(a => a.Id == dto.Id);
