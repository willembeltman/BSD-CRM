...
public class BankStatementInvoiceServiceHander
{
    private readonly AuthenticationState State;

    public BankStatementInvoiceServiceHander(AuthenticationState authenticationState)
    {
    ...
    public BankStatementInvoice? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.BankStatementInvoice dto) => db.BankStatementInvoices.FirstOrDefault(a => a.Id == dto.Id);
