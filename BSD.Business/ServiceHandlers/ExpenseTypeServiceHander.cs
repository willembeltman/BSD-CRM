...
public class ExpenseTypeServiceHander
{
    private readonly AuthenticationState State;

    public ExpenseTypeServiceHander(AuthenticationState authenticationState)
    {
    ...
    public ExpenseType? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.ExpenseType dto) => db.ExpenseTypes.FirstOrDefault(a => a.Id == dto.Id);
