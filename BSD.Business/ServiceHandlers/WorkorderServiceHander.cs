...
public class WorkorderServiceHander
{
    private readonly AuthenticationState State;

    public WorkorderServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Workorder? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Workorder dto) => db.Workorders.FirstOrDefault(a => a.Id == dto.Id);
