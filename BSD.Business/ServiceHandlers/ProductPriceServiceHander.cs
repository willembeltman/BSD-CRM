...
public class ProductPriceServiceHander
{
    private readonly AuthenticationState State;

    public ProductPriceServiceHander(AuthenticationState authenticationState)
    {
    ...
    public ProductPrice? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.ProductPrice dto) => db.ProductPrices.FirstOrDefault(a => a.Id == dto.Id);
