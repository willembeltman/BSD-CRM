...
public class InvoiceEmailServiceHandler
{
    private readonly AuthenticationState State;

    public InvoiceEmailServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public InvoiceEmail? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.InvoiceEmail dto) => null;
