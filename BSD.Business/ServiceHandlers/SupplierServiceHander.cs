...
public class SupplierServiceHander
{
    private readonly AuthenticationState State;

    public SupplierServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Supplier? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Supplier dto) => db.Suppliers.FirstOrDefault(a => a.Id == dto.Id);
