...
public class InvoiceAttachmentServiceHander
{
    private readonly AuthenticationState State;

    public InvoiceAttachmentServiceHander(AuthenticationState authenticationState)
    {
    ...
    public InvoiceAttachment? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.InvoiceAttachment dto) => db.InvoiceAttachments.FirstOrDefault(a => a.Id == dto.Id);
