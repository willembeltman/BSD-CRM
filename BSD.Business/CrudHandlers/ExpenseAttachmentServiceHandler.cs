...
public class ExpenseAttachmentServiceHandler
{
    private readonly AuthenticationState State;

    public ExpenseAttachmentServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public ExpenseAttachment? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.ExpenseAttachment dto) => null;
