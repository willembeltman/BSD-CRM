...
public class TaxRateServiceHandler
{
    private readonly AuthenticationState State;

    public TaxRateServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public TaxRate? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.TaxRate dto) => null;
