...
public class WorkorderAttachmentServiceHander
{
    private readonly AuthenticationState State;

    public WorkorderAttachmentServiceHander(AuthenticationState authenticationState)
    {
    ...
    public WorkorderAttachment? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.WorkorderAttachment dto) => db.WorkorderAttachments.FirstOrDefault(a => a.Id == dto.Id);
