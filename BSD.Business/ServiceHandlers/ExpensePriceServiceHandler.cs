...
public class ExpensePriceServiceHandler
{
    private readonly AuthenticationState State;

    public ExpensePriceServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public ExpensePrice? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.ExpensePrice dto) => null;
