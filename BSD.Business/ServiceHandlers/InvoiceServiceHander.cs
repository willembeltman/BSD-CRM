...
public class InvoiceServiceHander
{
    private readonly AuthenticationState State;

    public InvoiceServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Invoice? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Invoice dto) => db.Invoices.FirstOrDefault(a => a.Id == dto.Id);
