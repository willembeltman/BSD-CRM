...
public class InvoiceWorkorderServiceHander
{
    private readonly AuthenticationState State;

    public InvoiceWorkorderServiceHander(AuthenticationState authenticationState)
    {
    ...
    public InvoiceWorkorder? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.InvoiceWorkorder dto) => db.InvoiceWorkorders.FirstOrDefault(a => a.Id == dto.Id);
