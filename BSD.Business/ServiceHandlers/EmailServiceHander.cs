...
public class EmailServiceHander
{
    private readonly AuthenticationState State;

    public EmailServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Email? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Email dto) => db.Emails.FirstOrDefault(a => a.Id == dto.Id);
