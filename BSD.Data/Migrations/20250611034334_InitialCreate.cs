        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageLength = table.Column<long>(type: "bigint", nullable: true),
                    StorageMimeType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Place = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RekeningNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Publiekelijk = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseId = table.Column<long>(type: "bigint", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailUniqueId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StorageFileName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    StorageLength = table.Column<long>(type: "bigint", nullable: true),
                    StorageMimeType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageFileName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    StorageLength = table.Column<long>(type: "bigint", nullable: true),
                    StorageMimeType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
