...
public class ExperienceAttachmentServiceHander
{
    private readonly AuthenticationState State;

    public ExperienceAttachmentServiceHander(AuthenticationState authenticationState)
    {
    ...
    public ExperienceAttachment? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.ExperienceAttachment dto) => db.ExperienceAttachments.FirstOrDefault(a => a.Id == dto.Id);
