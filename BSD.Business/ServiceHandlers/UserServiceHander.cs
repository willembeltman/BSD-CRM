...
public class UserServiceHander
{
    private readonly AuthenticationState State;

    public UserServiceHander(AuthenticationState authenticationState)
    {
    ...
    public User? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.User dto) => db.Users.FirstOrDefault(a => a.Id == dto.Id);
