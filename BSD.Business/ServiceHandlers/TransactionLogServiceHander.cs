...
public class TransactionLogServiceHander
{
    private readonly AuthenticationState State;

    public TransactionLogServiceHander(AuthenticationState authenticationState)
    {
    ...
    public TransactionLog? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.TransactionLog dto) => db.TransactionLogs.FirstOrDefault(a => a.Id == dto.Id);
