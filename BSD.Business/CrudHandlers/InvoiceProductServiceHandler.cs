...
public class InvoiceProductServiceHandler
{
    private readonly AuthenticationState State;

    public InvoiceProductServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public InvoiceProduct? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.InvoiceProduct dto) => null;
