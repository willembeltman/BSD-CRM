...
public class InvoiceRowServiceHandler
{
    private readonly AuthenticationState State;

    public InvoiceRowServiceHandler(AuthenticationState authenticationState)
    {
    ...
    public InvoiceRow? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.InvoiceRow dto) => null;
