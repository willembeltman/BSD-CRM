...
public class ExpenseServiceHander
{
    private readonly AuthenticationState State;

    public ExpenseServiceHander(AuthenticationState authenticationState)
    {
    ...
    public Expense? FindByMatch(ApplicationDbContext db, BSD.Shared.Dtos.Expense dto) => db.Expenses.FirstOrDefault(a => a.Id == dto.Id);
